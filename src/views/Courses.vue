<template>
  <div class="container py-5">
    <NavTabs />
    <h1 class="mt-5">首頁 - 課程列表</h1>

    <div class="row">
      <!-- 課程卡片 CourseCard-->
      <CourseCard v-bind:initialCourses="courses" @after-delete-followed="afterDelteFollowed"
      @after-delete-course="afterDeleteCourse" />
    </div>
  </div>
</template>
